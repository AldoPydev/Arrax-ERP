        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form_desing">
                    ...
                    <div class="form-body">
                        <!-- RUTA DE ACCION FORM-->
                        <form class="form_user_edit" method="POST" action="{{ route('admin.users.update', $user) }}">
                            ...
                            <div class="user_content mb-3">
                                ...
                                <div class="user_item">
                                    ...
                                    <input id="correo" type="email" class="form-control" name="correo"
                                        value="{{ old('correo', $user->correo) ?: 'Sin dato' }}">
                                </div>
                            ...
                            <div class="user_content mb-3">
                                ...
                                <div class="user_item">
                                    ...
                                    <input id="telefono" type="text" class="form-control" name="telefono"
                                        value="{{ old('telefono', $user->telefono) ?: 'Sin dato' }}">
                                ...
                                <div class="user_item">
                                    ...
                                    <input id="profesion" type="text" class="form-control" name="profesion"
                                        value="{{ old('profesion', $user->profesion) ?: 'Sin dato' }}">
                                </div>
                            ...
                            <div class="user_content mb-3">
                                ...
                                <div class="user_item">
                                    ...
                                    <input id="empleado" type="text" class="form-control" name="empleado"
                                        value="{{ old('empleado', $user->empleado) ?: 'Sin dato' }}">
                                </div>
