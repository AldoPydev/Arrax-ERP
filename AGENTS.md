...
**Regla de comunicación:** consulta los archivos en carpeta `steering` para conocer la estructura del proyecto, complementos,  normas.
...
**Regla de actualización:** Si existen cambios en la estructura del proyecto, nuevas carpetas, nuevos archivos o eliminacion de carpetas y archivos. `Actualizar archivo structure.md.`
